...
namespace FrockRaytracer.Utils
{
    public static class Draw
    {
        ...
        /// <param name="c"></param>
        static void DrawCircle(this Raster raster, int px, int py, int radius, Color c) {
            int x = radius-1;
            int y = 0;
            int dx = 1;
            int dy = 1;
        ...
        /// <param name="y2"></param>
        /// <param name="c"></param>
        static void Box(this Raster raster, int x1, int y1, int x2, int y2, Color c) {
            for(int x = x1; x < x2; ++x) {
        ...
        static void DrawLine(this Raster raster, float x1, float y1, float x2, float y2, Color color ) {

...
namespace FrockRaytracer.Graphics
{
    ...
    public class Shader
    {
        ...
        public Shader(string vs, string fs)
        {
            ...
            if(vs != null) GraphicUtils.LoadShader(vs, ShaderType.VertexShader, prID, out vsID);
            if(fs != null) GraphicUtils.LoadShader(fs, ShaderType.FragmentShader, prID, out fsID);
            GL.LinkProgram(prID);
